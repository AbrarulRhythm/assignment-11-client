...
const TuitionManagement = () => {
    ...
    const { isLoading, data: responseData = { result: [], count: 0 }, refetch } = useQuery({
        queryKey: ['tuitions', searchText, currentPage],
        queryFn: async () => {
            const res = await axiosSecure.get(`/tuitions?searchText=${searchText}&skip=${currentPage * limit}&limit=${limit}`);
            return res.data;
        },
