...
const TuitionDetails = () => {
    ...
    const { isLoading, data: tutionDetails = null } = useQuery({
        queryKey: ['tuitionDetails', tuitionId],
        queryFn: async () => {
            const res = await axiosInstance.get(`/tuitions/${tuitionId}`);
            return res.data;
        }
    });
                                ...
                                <div className='flex flex-wrap -mx-3'>
                                    ...
                                    <div className='w-full md:w-6/12 lg:w-4/12 px-3'>
                                        <div className='p-6 rounded-md bg-content-bg sticky top-[124px]'>
                                            ...
                                            <div className='flex justify-between ite mb-4'>
                                            ...
                                            <button className='text-white font-medium rounded-md bg-theme-primary hover:shadow-btn-inner duration-300 cursor-pointer py-3 px-4 w-full mb-3'>Apply Now</button>
